#!/usr/bin/env Rscript
#USE GTEx adipose V8 data, including ambiguous SNPs, use TPM+TMM gene expression, add new controls
...
#salloc -t 6-1 --constraint=gizmok -n 35 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_adipose.R &
#regular TWAS-step 1----------------
...
#load data
load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8adiposedata_ambiguous_TPM_addcontrols_for_prediction.RData")
library(glmnet)
...
Sys.time()
prefix="dist500K_GTEx_adipose_Jan19"
...
if (thirdstep==T)
{
  ...
  if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8adiposedata_ambiguous_TPM_addcontrols_for_prediction.RData") #phenotypepos
