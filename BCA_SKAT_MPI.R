...
#mpoint <- ceiling(quantile(1:nrow(SKATout),0.95)/200)
#pindex <- c(1,(1:mpoint)*200,(mpoint*200+1):nrow(SKATout))

#0.05/nrow(SKATout)
#genesnptable[which(SKATout[,1]<0.05/nrow(SKATout)),]
#plot(-log((nrow(SKATout):1)/nrow(SKATout),base=10)[pindex],-log(SKATout[order(SKATout[,1],decreasing=T),1],base=10)[pindex],xlab="-log10 expected p-value",ylab="-log10 observed p-value")
#abline(0,1)

#plot(-log((nrow(SKATout):1)/nrow(SKATout),base=10)[pindex],-log(SKATout[order(SKATout[,2],decreasing=T),2],base=10)[pindex],xlab="-log10 expected p-value",ylab="-log10 observed p-value")
#abline(0,1)
#genesnptable[which(SKATout[,2]<0.05/nrow(SKATout)),]


#plot(-log((nrow(SKATout):1)/nrow(SKATout),base=10)[pindex],-log(SKATout[order(SKATout[,3],decreasing=T),3],base=10)[pindex],xlab="-log10 expected p-value",ylab="-log10 observed p-value")
#abline(0,1)
#genesnptable[which(SKATout[,3]<0.05/nrow(SKATout)),]
...
#plot(-log((nrow(SKATout):1)/nrow(SKATout),base=10)[pindex],-log(SKATout[order(SKATout[,4],decreasing=T),4],base=10)[pindex],xlab="-log10 expected p-value",ylab="-log10 observed p-value")
#abline(0,1)
#genesnptable[which(SKATout[,4]<0.05/nrow(SKATout)),]

#snpgenetable[grep("KLHL26",snpgenetable$gene),]

#snpgenetable[grep("PTPDC1",snpgenetable$gene),]