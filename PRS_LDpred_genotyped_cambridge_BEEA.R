...
BEEAsamples=sampletable1$localid[which(sampletable1$phenoEABE_bc==2)]
...
filesforGWAS=function(casesamples=BEEAsamples,controlsamples=COsamples,prefix="Discovery_genotyped_BEEA_CO")
{
...
udpate_fam=function(famfile="../result/GWAS/Discovery_genotyped_BEEA_CO_gwas.fam",phenofile="../result/GWAS/Discovery_genotyped_BEEA_CO_selectedsamples_pheno_plink.txt")
{
...
update_gwas=function(gwasfile="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GWAS/Discovery_genotyped_BEEA_CO_gwas.assoc.logistic",
                     bimfile="../result/GWAS/Discovery_genotyped_BEEA_CO_gwas.bim")
{
...
BEEAmeta=as.data.frame(fread("../result/Discovery_Bonn_METAANALYSIS_BEEA_genotyped_comsnp1.tbl"))
colnames(BEEAmeta)[which(colnames(BEEAmeta)=="P-value")]="P"
BEEABeacon=as.data.frame(fread("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/BEEA_Discovery_genotyped_BD_autosomes_comsnp_N.txt"))
idx=match(BEEAmeta$MarkerName,BEEABeacon$SNP)
BEEAmeta$chr=BEEABeacon$CHR[idx]
BEEAmeta$pos=BEEABeacon$position[idx]
write.table(BEEAmeta,file="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/BEEA_Discovery_Bonn_genotyped_metastat.txt",col.names = T,
            row.names=F,quote=F,sep="\t")
cmd="gzip /fh/fast/dai_j/BEACON/BEACON_GRANT/result/BEEA_Discovery_Bonn_genotyped_metastat.txt"
system(cmd)
...
keep_nohetsamples=function(prefix="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/validationBEEA_filtered_30Nov2018_flip_noambiguous_QC")
{
...
generate_plink=function(prefix="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/validationBEEA_filtered_30Nov2018_flip_noambiguous_QC",
                        opt="BEEA",prefix1="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Validation_BEEA_genotyped",metadat=BEEAmeta)
{
  #
...
generate_plink(opt="BEEA",prefix1="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Validation_BEEA_genotyped",metadat=BEEAmeta)
#generate_plink(opt="BEEA",prefix1="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Beacon_BEEA_genotyped",metadat=BEEAmeta)


generate_covariate=function(prefix="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Validation_BEEA_genotyped")
{
...
#generate_covariate()
generate_covariate(prefix="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Validation_BEEA_genotyped")
...
plot_ROC(prefix="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/Validation_BEEA")
# [1] "p=1:auc_prs=0.599 auc_env=0.79"
# [1] "p=0.3:auc_prs=0.599 auc_env=0.79"
# [1] "p=0.1:auc_prs=0.6 auc_env=0.79"
# [1] "p=0.03:auc_prs=0.602 auc_env=0.791"
# [1] "p=0.01:auc_prs=0.605 auc_env=0.792"
