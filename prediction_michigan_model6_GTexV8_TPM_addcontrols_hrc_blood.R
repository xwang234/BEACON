#!/usr/bin/env Rscript
#USE GTEx blood V8 data, including ambiguous SNPs, use TPM+TMM gene expression, add new controls based on HRC maf=0.01 data
...
#salloc -t 6-1 --constraint=gizmok -n 21 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_hrc_blood.R &
#regular TWAS-step 1----------------
