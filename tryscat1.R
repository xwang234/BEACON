...
#outfolder="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_TCGA_PC4" #models stored for TCGA, came from prediction_michigan_models7.R
#outfolder="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_PC4" #models stored for GTEx, came from prediction_michigan_models6.R
...
compute_p_withcoeff_arow=function(i,genemodel=res_min,bcagenotype,X)
{
  genes=rownames(genemodel)[genemodel$glmflag==1]
  gene=genes[i]
  res=data.frame(BE_p=NA,EA_p=NA,BEA_p=NA,BEEA_p=NA,stringsAsFactors = F)
