#!/usr/bin/env Rscript
#USE GTEx junction V8 data, including ambiguous SNPs, use TPM+TMM gene expression, add new controls
...
#salloc -t 6-1 --constraint=gizmok -n 35 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_junction.R &
#regular TWAS-step 1----------------
...
#load data
load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8junctiondata_ambiguous_TPM_addcontrols_for_prediction.RData")
library(glmnet)
...
Sys.time()
prefix="dist500K_GTEx_junction_Jan19"
outfolder=paste0("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/",prefix)
if (!dir.exists(outfolder)) dir.create(outfolder)
sink(paste0(outfolder,"/TWAS1.log")) #TWAS1.log association analysis including 6 pcs
...
if (thirdstep==T)
{
  ...
  if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8junctiondata_ambiguous_TPM_addcontrols_for_prediction.RData") #phenotypepos
