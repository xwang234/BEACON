...
write.csv(genelist[idx,],file="../result/NEWGenesValidate_FWER.csv",quote=F,row.names = F)
write.csv(genelist[idx,],file="../result/NEWGenesValidate_FDR.csv",quote=F,row.names = F)
