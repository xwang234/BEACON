...
check_organ=function(outfolder="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_junction_HRC",opt="pc6",plotopt=T)
{
  print(outfolder)
  ...
  #heritability
  heritfile=paste0(outfolder,"/heritability_","1grm",".txt")
...
junction_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
...
stomach_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
...
blood_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
...
mucosa_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
...
muscularis_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
...
adipose_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=T)
