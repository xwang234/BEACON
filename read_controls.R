...
WTCCC_newcontrol1=gsub("_","SEP",WTCCC_newcontrol)
idx=match(WTCCC_newcontrol1,Cambridge_WTCCC1$V2)
write.table(Cambridge_WTCCC1[idx,1:2],file="../result/WTCCC_plinksamples.txt",col.names = F,row.names = F,sep="\t",quote=F)
