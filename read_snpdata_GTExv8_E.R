...
getsnpdata(inprefix="GTExV8adiposedata_ambiguous_TPM_for_prediction",
                    outprefix="GTExV8adiposedata_ambiguous_TPM_addcontrols_for_prediction")
getsnpdata(inprefix="GTExV8blooddata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8blooddata_ambiguous_TPM_addcontrols_for_prediction")
getsnpdata(inprefix="GTExV8junctiondata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8junctiondata_ambiguous_TPM_addcontrols_for_prediction")
getsnpdata(inprefix="GTExV8muscularisdata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8muscularisdata_ambiguous_TPM_addcontrols_for_prediction")
getsnpdata(inprefix="GTExV8stomachdata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8stomachdata_ambiguous_TPM_addcontrols_for_prediction")
