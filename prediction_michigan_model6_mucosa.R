...
prefix="dist500K_GTEx_mucosa_April18"
...
if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExmucosadatafor_prediction.RData") #phenotypepos
