...
# generate snp data for gtex data for TWAS analysis, considering added control samples
# covariate and phenotype files were created by read_GTExv8_EC_mucosa.R (previous version, without new controls)
#GTEx method
...
getsnpdata=function(inprefix="GTExV8mucosadata_ambiguous_TPM_for_prediction",
                    gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
                    dataset="merge_beacon_cambridge_hrc_maf005_snp",
                    outprefix="GTExV8mucosadata_ambiguous_TPM_addcontrolsHRC_maf005_for_prediction")
{
  print(inprefix)
  #load saved data (phenotype,covariate)
  load(paste0(outfolder,inprefix,".RData"))
  #folder to keep imputed data for TWAS
  ...
  for (chr in 1:22)
  {
    ...
    bim1file=paste0("/fh/fast/dai_j/BEACON/BEACON_GRANT/data/GTEx/genotype/",gtexprefix,chr,".bim")
    bim1=fread(bim1file)
    bim1=as.data.frame(bim1)
    ...
    str2=paste0(bim2$V4,"_",bim2$V5,"_",bim2$V6)
    idx=str11 %in% str2 | str12 %in% str2
    traw1file=paste0("/fh/fast/dai_j/BEACON/BEACON_GRANT/data/GTEx/genotype/",gtexprefix,chr,".traw.gz")
  ...
  save(snp,snppos,phenotype,phenotypepos,covariate,file=paste0(outfolder,outprefix,".RData"))
  
}

#maf 0.05,snp
getsnpdata(inprefix="GTExV8mucosadata_ambiguous_TPM_for_prediction",
                    gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
                    dataset="merge_beacon_cambridge_hrc_maf005_snp",
                    outprefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
# getsnpdata(inprefix="GTExV8mucosadata_ambiguous_TPM_for_prediction",
#                     outprefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_for_prediction")
getsnpdata(inprefix="GTExV8adiposedata_ambiguous_TPM_for_prediction",
                    outprefix="GTExV8adiposedata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
getsnpdata(inprefix="GTExV8blooddata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8blooddata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
getsnpdata(inprefix="GTExV8junctiondata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8junctiondata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
getsnpdata(inprefix="GTExV8muscularisdata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8muscularisdata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
getsnpdata(inprefix="GTExV8stomachdata_ambiguous_TPM_for_prediction",
           outprefix="GTExV8stomachdata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")

#maf 0.01,snp
getsnpdata(inprefix="GTExV8mucosadata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
getsnpdata(inprefix="GTExV8adiposedata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8adiposedata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
getsnpdata(inprefix="GTExV8blooddata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8blooddata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
getsnpdata(inprefix="GTExV8junctiondata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8junctiondata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
getsnpdata(inprefix="GTExV8muscularisdata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8muscularisdata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
getsnpdata(inprefix="GTExV8stomachdata_ambiguous_TPM_for_prediction",
           gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_flip_chr",
           dataset="merge_beacon_cambridge_hrc_maf001_snp",
           outprefix="GTExV8stomachdata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")

# #maf 0.01,snp del/ins (no indels in HRC)
# getsnpdata(inprefix="GTExV8mucosadata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# getsnpdata(inprefix="GTExV8adiposedata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8adiposedata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# getsnpdata(inprefix="GTExV8blooddata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8blooddata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# getsnpdata(inprefix="GTExV8junctiondata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8junctiondata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# getsnpdata(inprefix="GTExV8muscularisdata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8muscularisdata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# getsnpdata(inprefix="GTExV8stomachdata_ambiguous_TPM_for_prediction",
#            gtexprefix="GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001_flip_chr",
#            dataset="merge_beacon_cambridge_hrc_maf001_var",
#            outprefix="GTExV8stomachdata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")

#check overlap of snps

extract_snppos=function(prefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf005_for_prediction")
{
  load(paste0(outfolder,prefix,".RData"))
  print(dim(snp))
  return(snppos)
}

mucosa_1kg_maf005snppos=extract_snppos(prefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_for_prediction")
#5196891     411
mucosa_HRC_maf005snppos=extract_snppos()
#[1] 5064445     411
mucosa_HRC_maf001snppos=extract_snppos(prefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction")
#7139405     411

# mucosa_HRC_maf001varpos=extract_snppos(prefix="GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf001var_for_prediction")
# #7036801     411
all(rownames(mucosa_HRC_maf005snppos) %in% rownames(mucosa_HRC_maf001snppos))
# all(rownames(mucosa_HRC_maf001varpos) %in% rownames(mucosa_HRC_maf001snppos))
# tmp=sapply(1:nrow(mucosa_HRC_maf001varpos),function(x){nchar(mucosa_HRC_maf001varpos$minor[x])})

compare_2snppos=function(snppos1=mucosa_1kg_maf005snppos,snppos2=mucosa_HRC_maf005snppos)
{
  tmp=rownames(snppos1) %in% rownames(snppos2)
  print(sum(tmp))
  str11=paste0(snppos1$chr,"_",snppos1$pos,"_",snppos1$minor,"_",snppos1$major)
  str22=paste0(snppos2$chr,"_",snppos2$pos,"_",snppos2$minor,"_",snppos2$major)
  idx1=str11 %in% str22
  str22_=paste0(snppos2$chr,"_",snppos2$pos,"_",snppos2$major,"_",snppos2$minor)
  idx2=str11 %in% str22_
  print(sum(idx1)+sum(idx2))
}
compare_2snppos() #4930934
4930934/5196891
compare_2snppos(snppos2=mucosa_HRC_maf001snppos) #4934299

count_ambiguoussnps=function(snppos=mucosa_1kg_maf005snppos)
{
  idx1=which(snppos$minor %in% c("A","T") & snppos$major %in% c("A","T"))
  idx2=which(snppos$minor %in% c("C","G") & snppos$major %in% c("C","G"))
  tmp=length(idx1)+length(idx2)
  print(tmp)
  print(tmp/nrow(snppos))
}

count_ambiguoussnps(snppos=mucosa_HRC_maf001snppos)

#check number of indels in GTEx genotype (from WGS)
gtexbimfile="/fh/fast/dai_j/BEACON/BEACON_GRANT/data/GTEx/genotype/GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze_maf001.bim"
gtexbim=as.data.frame(fread(gtexbimfile))
tmp1=sapply(1:nrow(gtexbim),function(x) {nchar(gtexbim$V5[x])})
tmp2=sapply(1:nrow(gtexbim),function(x) {nchar(gtexbim$V6[x])})
(sum(tmp1>1)+sum(tmp2>1))/nrow(gtexbim) #0.06805236
