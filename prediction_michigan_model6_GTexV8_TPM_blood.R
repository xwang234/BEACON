#!/usr/bin/env Rscript
#USE GTEx blood V8 data, including ambiguous SNPs, use TPM+TMM gene expression
...
#salloc -t 6-1 --mem-per-cpu 32G -n 23 --partition=largenode mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_blood.R &
#regular TWAS-step 1----------------
...
#mpi.remote.exec(load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExblooddatafor_prediction.RData"))
...
if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8blooddatafor_prediction.RData") #phenotypepos
