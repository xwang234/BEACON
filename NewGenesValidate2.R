...
#genelist=read.csv("../result/SKAT_TWAS_newpc6_genes_r2_01_.csv")
genelist=read.csv("../result/SKAT_TWAS_newpc6_genes_heritability.csv")
...
write.csv(genelist[idx,],file="../result/NEWGenesValidate_heritability_FWER.csv",quote=F,row.names = F)
write.csv(genelist[idx,],file="../result/NEWGenesValidate_heritability_FDR.csv",quote=F,row.names = F)
#save(genelist,file="../result/NewGenesValidate1_res.RData")
organidx <- 2
opt <- "HRC"
