#!/usr/bin/env Rscript
#USE GTEx mucosa V8 data, including ambiguous SNPs, use TPM+TMM gene expression, add new controls
...
#salloc -t 6-1 --constraint=gizmok -n 21 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_hrc_mucosa.R &
#regular TWAS-step 1----------------
...
#load data
load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8mucosadata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction.RData")
library(glmnet)
...
Sys.time()
prefix="dist500K_GTEx_mucosa_HRC"
...
if (thirdstep==T)
{
  ...
  #if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8mucosadata_ambiguous_TPM_addcontrols_for_prediction.RData") #phenotypepos
