...
$plink --bfile $prefix \
  --keep ../result/GWAS/Discovery_genotyped_EA_CO_selectedsamples_plink.txt --make-bed \
  --out ../result/GWAS/Discovery_genotyped_EA_CO_gwas
#update_fam() in R
prefix=/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GWAS/Discovery_EA_CO_gwas
$plink --bfile  $prefix --covar  ../result/GWAS/Discovery_EA_CO_selectedsamples_pheno_plink.txt \
