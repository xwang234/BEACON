#!/usr/bin/env bash
#hg19-hg38,without removing ambiguous snps
...
snpflip(){
  local chr="$1"
  echo $chr
  prefix=/fh/fast/dai_j/BEACON/BEACON_GRANT/data/imputation/bca_1000g/chr${chr}_filter_hg19tohg38
...
tovcf() {
  local chr="$1"
  prefix=/fh/fast/dai_j/BEACON/BEACON_GRANT/data/imputation/bca_1000g/chr${chr}_filter_hg19tohg38_flip
