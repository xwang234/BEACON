...
#USE GTEx blood data
# #get all the data
#generated by read_GTEx_blood.R
...
test=compute_cor_arow(i=31565,ncv=10,distcutoff = 5e5)
test$numvar
Sys.time()
# #parallel
...
#mpi.remote.exec(load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8blooddatafor_prediction.RData"))
...
mpi_compute_cor=function(ncv=10,distcutoff=5e5)
{
  ...
  for (chr in 1:22)
  {
    ...
    save(res,chr,file="../result/tmp_res_min_GTExV8blood.RData")
  }
...
prefix="dist500K_GTEx_blood_May26"
