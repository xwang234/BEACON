#!/usr/bin/env Rscript
#USE GTEx stomach data
# #get all the data
#generated by read_GTEx_EC_stomach.R
...
#load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExstomachdatafor_prediction.RData")
library(Rmpi)
njobs=mpi.universe.size() - 1
print(njobs)
mpi.spawn.Rslaves(nslaves=njobs,needlog = F)
#mpi.remote.exec(load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8stomachdatafor_prediction.RData"))
...
mpi_compute_cor=function(ncv=10,distcutoff=5e5)
{
  ...
  for (chr in 1:22)
  {
    ...
    save(res,file="../result/tmp_res_min_GTExV8stomach.RData")
  }
...
prefix="dist500K_GTEx_stomach_May26"
