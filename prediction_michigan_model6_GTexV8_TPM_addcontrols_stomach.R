#!/usr/bin/env Rscript
#USE GTEx stomach V8 data, including ambiguous SNPs, use TPM+TMM gene expression, add new controls
...
#salloc -t 6-1 --constraint=gizmok -n 15 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_stomach.R &
#regular TWAS-step 1----------------
...
#load data
load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8stomachdata_ambiguous_TPM_addcontrols_for_prediction.RData")
library(glmnet)
...
Sys.time()
prefix="dist500K_GTEx_stomach_Jan19"
...
if (thirdstep==T)
{
  ...
  if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8stomachdata_ambiguous_TPM_addcontrols_for_prediction.RData") #phenotypepos
