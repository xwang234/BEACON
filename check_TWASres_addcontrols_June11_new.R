...
check_organ=function(outfolder="/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_junction_Jan19",opt="pc4",plotopt=T)
{
  print(outfolder)
...
junction_old_pc4=check_organ(outfolder=outfolder,opt="pc4",plotopt=F)
...
junction_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
...
stomach_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
...
blood_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
...
mucosa_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
...
muscularis_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
...
adipose_new_pc6=check_organ(outfolder=outfolder,opt="pc6",plotopt=F)
                      ...
                      r2cutoff=0,opt="old")
{
  ...
  for (i in 1:length(tissues))
  {
    ...
    {
      outfolder=paste0("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_",tissue,"_Jan19")
    }
    load(paste0(outfolder,"/preidiction_michigan_model.RData"))
    load(paste0(outfolder,"/skat_res.RData"))
