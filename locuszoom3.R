...
#add missing snps within 50BP and cor>0.6
...
locusplot_validation1(organ="adipose",genes="EXOC3",prefix="BEEA_Bonn",summarydat=BEEA_Bonnsummarydat,ymax=5,nsnp=26)
locusplot_validation1(organ="blood",genes="HSP90AA1",prefix="BE_Bonn",summarydat=BE_Bonnsummarydat,ymax=5,nsnp=89)
