...
$plink --bfile $prefix \
  --keep ../result/GWAS/Beacon_genotyped_EA_CO_selectedsamples_plink.txt --make-bed \
  --out ../result/GWAS/Beacon_genotyped_EA_CO_gwas
#update_fam() in R
prefix=/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GWAS/Beacon_genotyped_EA_CO_gwas
$plink --bfile  $prefix --covar  ../result/GWAS/Beacon_genotyped_EA_CO_selectedsamples_pheno_plink.txt \
