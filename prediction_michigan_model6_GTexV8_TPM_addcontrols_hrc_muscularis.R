...
#salloc -t 6-1 --constraint=gizmok -n 15 mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_addcontrols_hrc_muscularis.R &
#regular TWAS-step 1----------------
...
#load data
load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8muscularisdata_ambiguous_TPM_addcontrols_HRC_maf001_for_prediction.RData")
library(glmnet)
...
Sys.time()
prefix="dist500K_GTEx_muscularis_HRC"
