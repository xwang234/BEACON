...
#save(snp,snppos,phenotype,phenotypepos,covariate,file="../result/GTExmucosadatafor_prediction.RData")
...
#compute
test=compute_cor_arow(i=31565,opt="min",ncv=10,distcutoff = 5e5)
...
mpi.remote.exec(load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExmucosadatafor_prediction.RData"))
...
#optionA
prefix="glmnet_dist500K_GTExmucosa"
#optionB
prefix="elnet_dist500K_GTExmucosa"
...
##salloc -t 3-1 --mem-per-cpu 32G -n 6 --partition=largenode mpirun -n 1 /app/easybuild/software/R/3.3.3-foss-2016b-fh1/bin/R --interactive
