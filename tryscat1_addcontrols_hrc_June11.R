#!/usr/bin/env Rscript
#salloc -t 1-1 -n 21 --constraint=gizmok mpirun -n 1 Rscript ./tryscat1_addcontrols_hrc_June11.R &
#salloc -t 1-1 --constraint=gizmok -n 85 mpirun -n 1 R --interactive
...
outfolders=c("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_mucosa_HRC",
             "/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_junction_HRC",
             "/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_stomach_HRC",
             "/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_muscularis_HRC",
             "/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_adipose_HRC",
             "/fh/fast/dai_j/BEACON/BEACON_GRANT/result/dist500K_GTEx_blood_HRC")
...
for (outfolder in outfolders)
{
  ...
  if (file.exists(assocfile) & !file.exists(paste0(outfolder,"/skat_res.RData")))
  #if (file.exists(assocfile))
  {
    print(outfolder)
