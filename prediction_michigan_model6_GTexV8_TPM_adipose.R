#!/usr/bin/env Rscript
#USE GTEx adipose V8 data, including ambiguous SNPs, use TPM+TMM gene expression
...
#salloc -t 6-1 --mem-per-cpu 32G -n 21 --partition=largenode mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_adipose.R &
#regular TWAS-step 1----------------
...
Sys.time()
prefix="dist500K_GTEx_adipose_June11"
...
#load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8adiposedatafor_prediction.RData")
library(Rmpi)
njobs=mpi.universe.size() - 1
print(njobs)
mpi.spawn.Rslaves(nslaves=njobs,needlog = F)
#mpi.remote.exec(load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExadiposedatafor_prediction.RData"))
...
if (!exists("phenotypepos")) load("/fh/fast/dai_j/BEACON/BEACON_GRANT/result/GTExV8adiposedatafor_prediction.RData") #phenotypepos
