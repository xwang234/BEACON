#!/usr/bin/env Rscript
#USE GTEx mucosa V8 data, including ambiguous SNPs, use TPM+TMM gene expression
...
#salloc -t 6-1 --mem-per-cpu 32G -n 7 --partition=largenode mpirun -n 1 Rscript ./prediction_michigan_model6_GTexV8_TPM_mucosa.R &
#regular TWAS-step 1----------------
